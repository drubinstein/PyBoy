...
from pyboy.plugins.game_wrapper_pokemon_blue cimport GameWrapperPokemonBlue
# imports end
...
cdef class PluginManager:
    ...
    cdef public GameWrapperPokemonBlue game_wrapper_pokemon_blue
    ...
    cdef bint game_wrapper_pokemon_blue_enabled
    # plugin_cdef end
